  ...
  <div class="general">
    ...
    <div class="center">
      <section id="content">
        ...
        <div class="favorita" v-if="favorita">La película marcada es: <h3>{{favorita.title}}</h3></div>
      ...
      peliculas: [
        {
          title: "Titanic",
          year: 1997,
          image: "https://es.web.img3.acsta.net/medias/nmedia/18/86/91/41/19870073.jpg",
        },
        {
          title: "La comunidad",
          year: 2000,
        ...
        },
        {
          ...
          year: 2000,
          image:
            "https://nrfmagazine.com/wp-content/uploads/2012/12/Groove-la-pel%C3%ADcula_NRFmagazine.jpg",
        },
      ],
    };
  },
